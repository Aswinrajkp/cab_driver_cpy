        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text("Padamugal, kochi",style: afterinformations,)
            ],
          ),
          SizedBox(height: 20,),
          Row(
            ...
            children: [
              ...
              Text("ernakulam , kerala",style: afterinformations,)
            ],
          ),
          SizedBox(height: 20,),
          Row(
            ...
            children: [
              Text("You get :",style: afterinformations,),
              Text("₹ 250",style: afterinformations,)
            ],
          ),
          SizedBox(height: 20,),
                 NeumorphicButton(
